...
//    private static readonly DispatcherTimer _timer = new();
    private static readonly CpuInfoProvider _cpuInfoProvider = new();
    private static readonly GpuInfoProvider _gpuInfoProvider = new();
    private static readonly RamInfoProvider _ramInfoProvider = new();


    public SysInfoViewModel(double cpuUsage)
    {
    }
