...
public sealed class NuGetCatalogService 
//    : INuGetCatalogService
{
    ...
    //        );
    //    }
//    public Task<PackageContent> DownloadPackageAsync(string id, NuGetVersion version, CancellationToken token)
//    {
//        throw new NotImplementedException();
//    }
//
//    public Task<PackageVersionInfo?> GetLatestStableVersionAsync(string packageId, CancellationToken token)
//    {
//        throw new NotImplementedException();
//    }
//
//    public IAsyncEnumerable<PackageId> SearchPackagesAsync(string prefix, CancellationToken token)
//    {
//        throw new NotImplementedException();
//    }
}
