...
public sealed partial class SysInfoPage : Page
{
    ...
    {
        ViewModel.CPU = "// TODO: bind to an CPU Info PerformanceCounter.";
        ViewModel.GPU = "// TODO: bind to an GPU Info PerformanceCounter.";
        ...
        ViewModel.RAM = "// TODO: bind to an RAM Info PerformanceCounter.";
